...
#   1. Stages the Haskell static library (built for simulator via ios.nix -s)
#   2. Generates an Xcode project with xcodegen
#   3. Builds the app with xcodebuild for iphonesimulator
#   4. Boots an iOS Simulator, installs the .app, launches it
#   5. Captures os_log output and checks for lifecycle events
#
# Usage:
